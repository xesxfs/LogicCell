package
{
   ...
   public class SetScore1comboScene extends Scene
   {
      ...
      private var hudManager:HudManagerScore;
      
      public var undoBmd:BitmapDisplay;
      
      public function SetScore1comboScene()
      {
         var _loc1_:BitmapDisplay = null;
         super();
         Status.mode = 4;
         addChild(this.field = new Field(new StageData("0,0,ScoreAttack,5,4,11111111111111111111")));
