package
{
   public var StageManager:StageManagerClass = new StageManagerClass();
}
...
class StageManagerClass
{
   ...
   public var vecStageData:Vector.<StageData>;
   ...
   {
      super();
      this.vecStageData = new Vector.<StageData>();
   ...
   public function getStage(param1:int) : StageData
   {
      if(param1 == -1)
      {
